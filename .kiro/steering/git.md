...
## Security
- Never commit secrets, API keys, or passwords — full rules in `security.md`
- Review commits for sensitive information before pushing
- Use signed commits when possible

## Commit Identity

Which email address is allowed on which remote is governed by `bt.md`. Check it
before committing, since author identity is fixed at commit time.
